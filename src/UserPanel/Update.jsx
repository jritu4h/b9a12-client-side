  ...
  const onSubmit = (data) => {
    ...
    .then(imageResponse=> {
     ...
     if(imageResponse.success){
      ...
      console.log(petData)
         axiosSecure.patch(`/pet/${updateData._id}`,petData)
         .then(()=>{
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-lg mx-auto p-4">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          defaultValue={updateData.petName}
      ...
      <div className="mb-4">
        ...
        <input
          ...
          defaultValue={updateData.petAge}
          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none"
        />
      ...
      <div className="mb-4">
        ...
        <Listbox value={watch('petCategory')} onChange={(value) => setValue('petCategory', value)}>
          <Listbox.Button className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none">
            {watch('petCategory') || updateData.petCategory}
          </Listbox.Button>
          <Listbox.Options>
      ...
      <div className="mb-4">
        ...
        <input
          ...
          defaultValue={updateData.petLocation}
          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none"
        />
